...
import { NotFoundFallback } from '@/components/Fallbacks'
...
const routerDefinition: RouteObject[] = [
  {
    ...
    children: [
      ...
      { element: <Wallet />, path: ROUTER_LINKS.wallet.path },

      { element: <Navigate to="/404" />, path: '*' },
      { element: <NotFoundFallback />, path: '/404' },
    ],
  },
]
